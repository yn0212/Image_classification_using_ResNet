...
model = Sequential([model,Dense(500, activation='relu'),Dense(250, activation='relu'),
                    Dense(125, activation='relu'), Dense(62, activation='relu'), 
Dense(31, activation='relu'),Dense(10, activation='softmax')])  # 시그모이드 함수가 포함된 밀집층 추가
